...
namespace NCommon
{
	...
	enum class ERROR_CODE : short
	{
		...
		ROOM_MASTER_GAME_START_INVALID_DOMAIN = 310,
		ROOM_MASTER_GAME_START_INVALID_LOBBY_INDEX = 311,
		ROOM_MASTER_GAME_START_INVALID_ROOM_INDEX = 312,
		ROOM_MASTER_GAME_START_INVALID_MASTER = 313,
		ROOM_MASTER_GAME_START_INVALID_GAME_STATE = 314,
		ROOM_MASTER_GAME_START_INVALID_USER_COUNT = 315,
